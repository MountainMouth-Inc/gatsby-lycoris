        ...
        <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10 text-base max-w-prose prose prose-orange mx-auto lg:max-w-5xl lg:mx-0 lg:pr-72">
            <p className="text-lg text-gray-500 dark:text-gray-50">
              2021年3月23日、株式会社MountainMouthを設立しました。
            </p>
          </div>
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
            <div className="relative z-10">
              <div className="prose prose-orange text-gray-500 dark:text-gray-50 mx-auto lg:max-w-none">
                <p>
                  幼少の頃、アニメ『Sword Art Online』やスピルバーグの『Ready
                  Player
                ...
                <p>
                  ...
                  Mouthも技術の可能性を信じ、より良い未来を創れるよう、仕事をしていきたいと思います。
                </p>
                <h3 className="dark:text-gray-50">Bitcoin Standard</h3>
                <p>
                  ビットコインは人類史上最も重要な発明の一つです。弊社はビットコインへ積極的な投資と開発コミニティへ貢献を推進して参ります。
                </p>
              </div>
            </div>
              ...
              <blockquote className="relative bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                <div className="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
                  <div className="relative text-lg text-gray-700 dark:text-gray-300 font-medium">
                    ...
                    <p className="relative">Talk is cheap, show me the code.</p>
                  </div>
                </div>
                <cite className="relative flex items-center sm:items-start bg-cyan-500 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
                  ...
                  <span className="relative text-cyan-100 font-semibold leading-6 sm:ml-24 sm:pl-1">
                    ...
                    <br />
                    <p className="sm:inline">CEO & Founder @ Mountain Mouth</p>
                  </span>
                </cite>
              </blockquote>
            </div>
